 ...
 *
 * The screenshots are saved to `tests/_output/record_*` directories, open `blog_index.php` to see them as a slideshow.
 *
 * #### Installation
 *
...
EOF;
    ...
    public function persist(TestEvent $e)
    {
        ...
        $indexFile = $this->dir . DIRECTORY_SEPARATOR . 'blog_index.php';
